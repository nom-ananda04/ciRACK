...
# Checkbox that enables/disables the CLK output.
CB_CLK = "clk_enable"
...
# The exact source terminal strings, kept separate so they're easy to adjust:
NI_SOURCE = {
    CB_USB6421: "/Dev1/PFI2",            # USB-6421 count source (DIO2 -> PFI2)
    CB_CDAQ: "/cDAQ1Mod4/PFI5",          # cDAQ-9401 count source (DIO5 -> PFI5)
}
...
def count_nidaqmx(client, cb_id):
    ...
    with nidaqmx.Task() as task:
        ...
        # Route the physical input line to the counter's source terminal.
